...
```json
[
  { "borrowId": "b001", "personnelId": "p001", "materialId": "m001", "quantity": 1, "borrowDate": "2025-11-10T..." }
]
```
...
1.  调用 Python (8081): `POST /borrows` (创建新记录, **包含 quantity: 3**)
2.  调用 Node.js (8082): `PUT /materials/m002` (减少库存, **包含 quantity: 3**)
